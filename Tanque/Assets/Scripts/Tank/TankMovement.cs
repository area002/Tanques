...
{
 public int m_PlayerNumber = 1; // Utilizado para ident ificar qué tanque es de cada jugador.Configurado por el tank's manager.
 ...
 {
 // Al arrancar/habilitar el tanque, deshabilitamos la kinemátic a del tanque para que se pueda mover.
